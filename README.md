...
* Time Series (basic understanding)
...
* Provides insights and suggested interventions
* Includes SHAP-based explainability
* Built with Python, Scikit‑learn & Flask

### 📌 AI-based Web Applications

* ML models integrated with frontend UI
* Deployed lightweight apps (free hosting friendly)
...
* Improving applied statistics & ML math
* Building Fiverr‑ready AI & data science projects
* Deploying scalable ML web apps
...
* Remote & international opportunities (UAE / Global)
